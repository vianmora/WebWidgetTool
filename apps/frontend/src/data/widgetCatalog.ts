...
export const WIDGET_CATALOG: WidgetDefinition[] = [
  // ── Avis & témoignages ──
  {
    ...
    templates: [
      { id: 'list', label: 'Horizontal scroll', config: { layout: 'list' } },
      { id: 'grid', label: 'Vertical scroll', config: { layout: 'grid' } },
      { id: 'carousel', label: 'Carrousel', config: { layout: 'carousel' } },
      { id: 'masonry', label: 'Mosaïque', config: { layout: 'masonry' } },
    ],
    fields: [
      ...
      { key: 'layout', label: 'Disposition', type: 'select', options: [{ value: 'list', label: 'Horizontal scroll' }, { value: 'grid', label: 'Vertical scroll' }, { value: 'carousel', label: 'Carrousel' }, { value: 'masonry', label: 'Mosaïque' }] },
